...
static int
accessType_3_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
accessType_3_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
static void
accessType_3_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	accessType_3_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

static int
accessType_3_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
accessType_3_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
accessType_3_encode_der(asn_TYPE_descriptor_t *td,
...
static asn_dec_rval_t
accessType_3_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
static asn_enc_rval_t
accessType_3_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
static asn_dec_rval_t
accessType_3_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
static asn_enc_rval_t
accessType_3_encode_uper(asn_TYPE_descriptor_t *td,
...
static asn_per_constraints_t asn_PER_type_accessType_constr_3 GCC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_accessType_3 = {
	...
	accessType_3_free,
	accessType_3_print,
	accessType_3_constraint,
	accessType_3_decode_ber,
	accessType_3_encode_der,
	accessType_3_decode_xer,
	accessType_3_encode_xer,
	accessType_3_decode_uper,
	accessType_3_encode_uper,
